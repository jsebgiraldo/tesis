...
\include{03NodoIoT_Thread_LwM2M} % Cap 3: Nivel 1 - Nodo IoT (Thread + LwM2M) (NUEVO)
\include{04Gateway_HaLow_Edge} % Cap 4: Niveles 2-3 - Gateway + HaLow (NUEVO)
\include{05Server_ThingsBoard_Kafka} % Cap 5: Nivel 4 - Server ThingsBoard (NUEVO)
\include{06Resultados_Validacion} % Cap 6: Resultados End-to-End (CONSOLIDADO)
\include{07Conclusiones_TrabajoFuturo} % Cap 7: Conclusiones y Trabajo Futuro (COMPLETADO)
