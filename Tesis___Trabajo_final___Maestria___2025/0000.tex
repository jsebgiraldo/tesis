...
\renewcommand{\thesisname}{Diseño y Evaluación Experimental de una Arquitectura IoT\\ \vspace{2mm}\large{Centrada en Pasarelas de Borde Multiprotocolo para Infraestructura Avanzada de Medición (AMI)}}
\renewcommand{\thesisnameeng}{Design and Experimental Evaluation of an IoT Architecture\\ \vspace{2mm}\large{Centered on Multiprotocol Edge Gateways for Advanced Metering Infrastructure (AMI)}}
