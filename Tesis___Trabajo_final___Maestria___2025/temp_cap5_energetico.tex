...
\hline
Nodo ESP32-C6 & Medidor 5V aux & 3.3V & \textcolor{green}{\textbf{0.135 W}} continuo & MED RX always-on 19 mA + TX 22 mA + RS-485 35 mA picos, alimentado desde medidor  & 3.24 Wh \\
\hline
Transceptor RS-485 & Mismo 3.3V & 3.3V & 0.05 W & MAX485 idle 300$\mu$A, TX 15mA durante 10s/hora & 1.2 Wh \\
\hline
\rowcolor{yellow!10}
\textbf{Subtotal Nivel 1} & \multicolumn{3}{c|}{\textbf{2.33 W por nodo}} & \textbf{100 nodos $\times$ 2.33W} & \textbf{5,592 Wh/día} \\
\hline
...
\begin{itemize}
    \item \textbf{Medidores (Nivel 1): 94\%} del consumo total (5,592 Wh / 5,948 Wh). Dominante por cantidad (100 unidades $\times$ 1.8W c/u).
...
\begin{itemize}
    ...
    \item Ahorro energético 100 medidores: (5.3 - 2.47) $\times$ 100 $\times$ 24h = \textbf{6,792 Wh/día = 2,479 kWh/año}
...
\begin{itemize}
    ...
    \item \textbf{Energía disponible}: 12V $\times$ 7Ah $\times$ 0.8 (80\% DoD segura) = 67.2 Wh
...
\begin{itemize}
    ...
    \item \textbf{Energía disponible}: 12V $\times$ 20Ah $\times$ 0.9 (90\% DoD Li-ion) = 216 Wh
