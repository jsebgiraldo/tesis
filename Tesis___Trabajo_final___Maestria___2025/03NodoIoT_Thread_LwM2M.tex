...
El marco teórico (§\ref{sec:marco-thread}) justificó la elección de Thread~1.4 sobre IPv6~IEEE~802.15.4 frente a Zigbee y Wi-SUN. Esta sección documenta las \textbf{decisiones de configuración} adoptadas para el piloto y su justificación en función de los requisitos AMI.
