...
\begin{itemize}
    ...
    \item \textbf{Efectos long-term no evaluados}: 90 días insuficientes para evaluar: (1) Memory leaks en servicios containerizados, (2) Fragmentación Thread routing table, (3) Estabilidad alimentación 5V del medidor bajo condiciones de temperatura extrema (piloto operó 18-28°C, spec -20 a +60°C), (4) Drift RTC sin sincronización GPS.
