...
\subsection{Función del Gateway en la Arquitectura AMI}

En el contexto de Infraestructuras de Medición Avanzada (AMI), el gateway cumple las siguientes funciones críticas:
...
Para despliegue AMI Smart Grid se recomienda:
