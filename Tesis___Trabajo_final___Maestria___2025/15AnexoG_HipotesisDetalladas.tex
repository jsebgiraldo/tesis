...
\textbf{Nota:} Detección avanzada de anomalías no fue implementada en piloto actual. Esta funcionalidad requiere dataset de validación de 6-12 meses y upgrade de hardware del gateway.
...
\textbf{Criterio éxito:} $\geq$5 de 6 métricas cumpliendo los umbrales especificados
...
\hline
H2 & Procesamiento Edge & §5.2.2, §5.2.4 \\
\hline
