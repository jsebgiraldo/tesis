...
\hline
\rowcolor{gray!20}
\textbf{Característica} & \textbf{Thread 1.3}\footnotemark & \textbf{Zigbee 3.0} & \textbf{Bluetooth Mesh} \\
\hline
...
\hline
\end{tabular}}
\footnotetext{El piloto se implementó con Thread 1.3.0 (ESP32-C6 OpenThread stack, ESP-IDF 5.1). Thread 1.4.0, publicado en octubre 2024, incorpora mejoras de seguridad y eficiencia energética recomendadas para despliegue productivo. Detalles técnicos en §\ref{sec:nodo-thread}.}
\end{table}
