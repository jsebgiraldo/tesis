...
% === Overleaf: use pre-compiled TikZ PDFs instead of inline TikZ ===
% overleaf_figs/ contains wrappers that \includegraphics the pre-compiled PDFs
% in tikz_pdfs/. By putting overleaf_figs/ first in \input@path, \input{fig_xxx}
% finds the lightweight wrapper before the heavy TikZ original.
\makeatletter
\def\input@path{{overleaf_figs/}{./}}
\makeatother
...
\usepackage[main=spanish,english,ngerman,french,portuguese]{babel}
...
\graphicspath{{./}{tikz_pdfs/}{figures/}{00Figuras/}}
...
%\usepackage{minted} % Deshabilitado para Overleaf (causa timeout con -shell-escape)
\usepackage{fancyvrb}
...
\renewcommand{\thesisname}{Diseño y Evaluación Experimental de una Arquitectura IoT Centrada en Pasarelas de Borde Multiprotocolo para Infraestructura Avanzada de Medición (AMI)}
\renewcommand{\thesisnameeng}{Design and Experimental Evaluation of a Multiprotocol Edge-Centric IoT Architecture for Advanced Metering Infrastructure (AMI)}
\renewcommand{\thesisnamelang}{Nombre del trabajo o tesis en un tercer idioma} %Usar solo si se requiere
\renewcommand{\issuedate}{2026}
\renewcommand{\submissiondate}{Febrero 2026}
\renewcommand{\director}{Gustavo Osorio}
\renewcommand{\directortitle}{Profesor - Departamento de Ingeniería Eléctrica, Electrónica y Computación}
...
\renewcommand{\researchtopic}{Ciudades Inteligentes \\ Infraestructura Avanzada de Medición \\ Redes IPv6 para IoT}
\renewcommand{\sede}{Sede Manizales} 
\renewcommand{\department}{Departamento de Ingeniería Eléctrica, Electrónica y Computación}
%\renewcommand{\departmenttwo}{} %No aplica
...
\renewcommand{\palabrasclave}{Internet de las Cosas (IoT), IEEE 802.11ah, Wi-Fi HaLow, Thread, 6LoWPAN, LwM2M, CoAP, MQTT, Smart Energy, DLMS/COSEM, AMI, Edge Computing, Gateway IoT, Seguridad IoT, ISO/IEC 30141, Calidad de servicio, Interoperabilidad} 
\renewcommand{\keywords}{Internet of Things (IoT), IEEE 802.11ah, Wi-Fi HaLow, Thread, 6LoWPAN, LwM2M, CoAP, MQTT, Smart Energy, DLMS/COSEM, AMI, Edge Computing, IoT Gateway, IoT Security, ISO/IEC 30141, Quality of Service, Interoperability}
...
\newcommand{\shortthesisname}{Arquitectura IoT centrada en Pasarelas de Borde Multi-protocolo}
\fancypagestyle{plain}{
\fancyhead[RO,LE]{}
\fancyhead[RE,LO]{\scriptsize \textbf{\shortthesisname}}
...
\fancyhead[RO,LE]{\scriptsize\rightmark}
\fancyfoot[CO,CE]{\thepage}
\thispagestyle{fancy}%
...
\usetikzlibrary{calc,arrows.meta,positioning,shapes.geometric,shadows,fit,patterns,decorations.pathreplacing,decorations.pathmorphing,backgrounds}% per right to e left to
...
% ============================================================================
% NUEVA ESTRUCTURA: Enfoque por NIVELES (aprobado por tutor 27/Nov/2025, actualizado Feb/2026)
% ============================================================================
...
%Inicio del apéndice o anexos --- OCULTOS para revisión de contenido principal
%\begin{appendix}
...
%\include{05Server_ThingsBoard_Kafka} % Anexo H: Arquitectura Server On-Premise (Trabajo Futuro)
%\end{appendix}
