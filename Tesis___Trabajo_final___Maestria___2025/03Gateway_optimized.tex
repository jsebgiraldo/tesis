...
\begin{itemize}
    ...
    \item Conectividad: 2 $\times$ USB 3.0, 2 $\times$ USB 2.0 (para dongles Thread/LTE), Ethernet Gigabit, GPIO 40-pin.
...
Raspberry Pi 4 & 4$\times$1.5 GHz & 4 GB & 12.5 W & \$55 \\ \hline
NVIDIA Jetson Nano & 4$\times$1.43 GHz & 4 GB & 10 W & \$99 \\ \hline
BeagleBone Black & 1$\times$1 GHz & 512 MB & 2.3 W & \$60 \\ \hline
Intel NUC i3 & 2$\times$3.0 GHz & 8 GB & 25 W & \$299 \\ \hline
\end{tabular}
\end{table}
...
Esta vista se actualiza automáticamente cada 5 minutos, permitiendo consultas agregadas 100$\times$ más rápidas.
...
Capacidad de buffer: 100 medidores $\times$ 96 lecturas/día $\times$ 7 días = 67,200 registros ≈ 8 MB (con índices ~30 MB).
