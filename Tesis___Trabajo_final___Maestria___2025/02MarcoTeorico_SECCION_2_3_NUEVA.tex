...
\footnotesize
\begin{tabular}{|p{3cm}|p{1.8cm}|p{1.8cm}|p{3.5cm}|}
\hline
\rowcolor{blue!20}
\textbf{Workload} & \textbf{Latencia Req.} & \textbf{Tier Óptimo} & \textbf{Justificación} \\
\hline
\textbf{DER control (disconnect)} & <100 ms & \textcolor{green}{\textbf{Edge}} & Latencia cloud 50-200 ms insuficiente \\
\hline
\textbf{Power quality monitoring} & <10 ms & \textcolor{green}{\textbf{Edge}} & Detección sag/swell requiere <1 ciclo AC \\
\hline
\textbf{Waveform compression} & <50 ms & \textcolor{green}{\textbf{Edge}} & Reduce bandwidth 90\% antes upload \\
\hline
\textbf{Anomaly detection local} & <1 s & \textcolor{green}{\textbf{Edge}} & Alertas inmediatas sin WAN dependency \\
\hline
\textbf{Dashboards locales} & <2 s & \textcolor{green}{\textbf{Edge}} & Operación durante outages WAN \\
\hline
\textbf{Consumption forecasting} & 1-10 min & \textcolor{blue}{\textbf{Cloud}} & Requiere ML models pesados + históricos \\
\hline
\textbf{Analytics multi-utility} & 10-60 min & \textcolor{blue}{\textbf{Cloud}} & Agregación millones medidores cross-region \\
\hline
\textbf{Billing generation} & Daily batch & \textcolor{blue}{\textbf{Cloud}} & Integration ERP/CRM enterprise systems \\
\hline
\textbf{Long-term storage (5 años)} & N/A & \textcolor{blue}{\textbf{Cloud}} & S3/Glacier lifecycle policies cost-effective \\
\hline
\end{tabular}
\end{table}
...
\footnotesize
\begin{tabular}{|p{3cm}|p{2.2cm}|p{2.2cm}|p{3cm}|}
\hline
\rowcolor{gray!20}
\textbf{Componente Latencia} & \textbf{Edge Computing} & \textbf{Cloud Computing} & \textbf{Referencia} \\
\hline
\textbf{Uplink device → processor} & 1-5 ms & 20-80 ms & \cite{andriuloEdgeComputingCloud2024} \\
