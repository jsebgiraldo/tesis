...
Seleccionado por su balance costo/rendimiento: SoC Broadcom BCM2711 (Quad-core Cortex-A72 @ 1.8 GHz), 4 GB RAM, 16 GB eMMC + 256 GB NVMe SSD (vía USB 3.0 adapter), Ethernet Gigabit, 4$\times$ USB 3.0/2.0, GPIO 40-pin para expansión.
...
Thread es un protocolo mesh IPv6 optimizado para IoT: baja latencia (<50 ms típico), soporte para nodos de bajo consumo (SED <10 µA), auto-healing con rerouting automático, y escalabilidad hasta 250 nodos por red. En esta arquitectura los nodos operan como MED alimentados desde el medidor. El gateway ejecuta OTBR para formar red Thread en canal 15 (2.435 GHz) con prefix \texttt{fd00::/64}.
...
TimescaleDB extiende PostgreSQL con optimizaciones para series temporales: (1) particionamiento automático (hypertables), (2) compresión 10-20$\times$ después de 7 días, (3) continuous aggregates para vistas materializadas (15-min, 1-hora, 1-día), (4) retención automática (90 días), y (5) queries eficientes con \texttt{time\_bucket()}.
